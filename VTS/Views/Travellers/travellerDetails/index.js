...
const TravellerDetails = () => {
    ...
    const data = [
        {images:Images.img4 , name: "Malik Sardar, 40"},
        {images:Images.img2 , name: "Malik Sardar, 40"},
        {images:Images.img3 , name: "Malik Sardar, 40"},
        {images:Images.img1 , name: "Malik Sardar, 40"},
        {images:Images.img2 , name: "Malik Sardar, 40"},
        {images:Images.img4 , name: "Malik Sardar, 40"},
        {images:Images.img3 , name: "Malik Sardar, 40"},
        {images:Images.img1 , name: "Malik Sardar, 40"},
                ...
                <View style={{height : '100%', marginTop : hp(37),paddingTop : hp(5), backgroundColor : '#fff', borderTopLeftRadius : wp(5),borderTopRightRadius : wp(5), elevation : 25}}>
                   <View style={{flexDirection : 'row', paddingHorizontal : wp(5) }}>
                    ...
                    <View style={{justifyContent : 'center', alignItems : 'center', marginHorizontal : wp(3), paddingHorizontal : wp(5) }}>
                        <Text style={{fontSize : Size(3), fontWeight : 'bold', color : 'rgba(0,0,0,0.7)'}}>Malik Sardar, 40</Text>
                    </View>
                    </View>
                    ...
                    <View style={{justifyContent : 'center', alignItems : 'flex-start', marginHorizontal : wp(3)}}>
                        ...
                        <Text style={{fontSize : Size(1.3), color : 'rgba(0,0,0,0.7)'}}>19 Nov 1980</Text>
                    </View>
                    </View>
                    ...
                    <Text style={{paddingHorizontal : wp(5), marginVertical : hp(2),lineHeight : hp(3)}}>Pick and Drop from 6am to 7pm. Works on weekends too.</Text>
                    <View style={{height : hp(3)}}></View>
                    <View style={{flexDirection : 'row',backgroundColor : 'rgba(0,0,0,0.1)', paddingHorizontal : wp(5) }}>
                    ...
                    {/* Prefrred Areas */}
                        ...
                        <View>
                        <Text style={{fontSize : Size(2),paddingVertical : hp(.7) }}>Address </Text>
                        </View>
                    </View>
                    <Text style={{paddingHorizontal : wp(5), marginVertical : hp(2),lineHeight : hp(3)}}>House 145-D, Street 56, Iqbal Town,</Text>
                    <View style={{height : hp(3)}}></View>
                    <View style={{flexDirection : 'row',backgroundColor : 'rgba(0,0,0,0.1)', paddingHorizontal : wp(5) }}>
                        <View>
                    ...
                    <Text style={{paddingHorizontal : wp(5), marginVertical : hp(2),lineHeight : hp(3)}}> Number of students : 20 {"\n"} Average Rating : *****</Text>
