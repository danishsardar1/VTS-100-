            ...
            <View style={{ flex: 1 }}>
              ...
              <FlatList
                ...
                renderItem={({ item, index }) => {
                  ...
                  return <TouchableOpacity onPress={() => { nativeSms(item.MobNo) }} style={{ flex: 1, flexDirection: 'row', marginVertical: hp(2), borderBottomWidth: 0.2, borderBottomColor: Colors.lightGray, marginHorizontal: wp(3) }}>
